...
class ExpenseTracker:
    ...
    def create_widgets(self):
        ...
        self.category_combobox['values'] = ('Еда', 'Транспорт', 'Развлечения', 'Здоровье', 'Образование', 'Одежда', 'Коммунальные услуги', 'Другое')
        ...
        self.filter_category_combobox['values'] = ('Все', 'Еда', 'Транспорт', 'Развлечения', 'Здоровье', 'Образование', 'Одежда', 'Коммунальные услуги', 'Другое')
    ...
    def update_table(self):
        ...
        self.total_label.config(text=f"Общая сумма: {total_sum:.2f}")
